...
#mlp_classifier = MLPClassifier(hidden_layer_sizes=(100,100,100), max_iter=1000, alpha=0.0001, solver='sgd', verbose=10,  random_state=21,tol=0.000000001)
#mlp_classifier.fit(x_values_train, y_values_train)
#print('Neural Net')
#print(mlp_classifier.score(x_values_test, y_values_test))
